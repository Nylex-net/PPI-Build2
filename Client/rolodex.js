...
function starter(res) {
    ...
    '<div class="col-lg-4"><label for="WP">Work Phone </label></div><div class="col-lg-8"><input type="tel" id="WP" name="WP" maxlength="20" value="'+json.work_phone+'"required></div>'+
    '<div class="col-lg-4"><label for="HP">Home Phone </label></div><div class="col-lg-8"><input type="tel" id="HP" name="HP" value="'+json.home_phone+'" maxlength="20"></div>'+
    '<div class="col-lg-4"><label for="cell">Cell </label></div><div class="col-lg-8"><input type="tel" id="cell" name="cell" value="'+ json.cell +'" maxlength="20"></div>'+
    '<div class="col-lg-4"><label for="fax">Fax </label></div><div class="col-lg-8"><input type="tel" id="fax" name="fax" value="'+ json.fax +'" maxlength="20"></div>'+
