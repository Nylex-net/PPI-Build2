...
function page5() {
    ...
    '<div class="grid-item"><label for="WP">Work Phone<span class="astrick">*</span><br>(Extension optional)</label></div><div class="grid-item"><input type="tel" id="WP" name="WP" maxlength="12" required><label for="ext"> Ext:</label><input type="text" id="ext" name="ext" maxlength="3"></div>'+
