            ...
            (async function(){
                ...
                const table = {
                    ...
                    rows: [
                        ...
                        ["Prevailing Wage", removeEscapeQuote(req.body.PREVAILING_WAGE).toString()],
            ...
            (async function(){
                ...
                const table = {
                  ...
                  rows: [
                    ...
                    ["Keywords", req.body.ProjectKeywords, "Work Phone", removeEscapeQuote(req.body.PhoneW1).toString()],
